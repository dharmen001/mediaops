...
CLIENT_SECRET_FILE = 'C:\\Users\\rajiv.ranjan\\Downloads\\event\\client_secret.json'
APPLICATION_NAME = 'ps'
...
def get_credentials():
    ...
    '''
    credential_path = 'C:\\Users\\rajiv.ranjan\\Downloads\\event\\credentials.json'
